...
def modelo_view(request):
	...
	return render(request, 'teste128/modelo128_view.html', {'paginacao':dadosPaginacao,'dadosModelo':dadosModelo})
...
def salvar(request):
	...
	dadosModelo = Modelo128.objects.all()
	dadosPaginacao = paginacao(request,dadosModelo)
	return render(request, 'teste128/modelo128_view.html', {'dadosModelo':dadosModelo,'paginacao':dadosPaginacao})
...
def remover(request):
	...
	dadosModelo = Modelo128.objects.all()
	dadosPaginacao = paginacao(request,dadosModelo)
	return render(request, 'teste128/modelo128_view.html', {'dadosModelo':dadosModelo,'paginacao':dadosPaginacao,'codigo':codigo})	
	
def editar(request):
	codigo = request.GET.get('id')
	edit = Modelo128.objects.get(campo1=codigo)
	return render(request, 'teste128/editar_view.html', {'editar':edit,'codigo':codigo})
...
def sobre(request):
	return render(request, 'teste128/sobre_view.html', {})	
